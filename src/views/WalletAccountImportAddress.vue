  ...
  <div>
    ...
    >
      ...
      <div class="alert-body">
        <span>Explorer.erialos.me is a Ping.pub fork, which is maintained by the community, Everyone could add a chain to ping.pub. Some of those blockchains are not fully tested, Use at your own risk.</span>
      </div>
    </b-alert>
    <form-wizard
      ref="wizard"
